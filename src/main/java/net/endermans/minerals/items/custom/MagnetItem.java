package net.endermans.minerals.items.custom;
...
public class MagnetItem extends Item {
    ...
    private final static TagKey<Item> notTeleportableItem = TagKey.of(Registry.ITEM_KEY, new Identifier(EndermansMinerals.MOD_ID, "not_teleportable_item"));
    ...
    public MagnetItem(short maxRange, int damage, short speed) {
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(Text.translatable("item.minerals.magnet.tooltip.range", maxRange));
        tooltip.add(Text.translatable("item.minerals.magnet.tooltip.speed", this.speed));
        tooltip.add(Text.translatable("item.minerals.magnet.tooltip.state", this.getState(itemStack) ? "Enabled" : "Disabled"));
    }
